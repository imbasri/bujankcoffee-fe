   ...
   return (
      <>
         <footer className="container-fluid">
            <div
               className={`container d-flex ${styles["footer-center-box"]} py-5`}
            >
               <aside className={styles["footer-left"]}>
                  <img src={icon_coffee} alt="icon_coffee" />
                  <span className={styles["footer-title-left"]}>
                     Bujank Coffee
                  </span>
                  <p>
               ...
               <aside
                  className={`container d-flex flex-row justify-content-end ${styles["ft-right"]}`}
               >
                  <div className="d-flex flex-column me-5">
                     <div
                        className={`${styles["footer-right"]} d-flex flex-row mt-2 mb-3`}
                     >
                        <span>Product</span>
                     </div>
                     <div
                        className={`${styles["footer-right-link"]} d-flex flex-column`}
                     >
                        <span>Download</span>
                        <span>Pricing</span>
                        <span>Locations</span>
