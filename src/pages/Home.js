         ...
         <main>
                     ...
                     <div className={`${styles["products"]} `}>
                        ...
                        >
                           ...
                           <div className={`${styles["content_order"]}`}>
                              <h3>IDR 25.000</h3>
                              <Link className={`${styles["order"]}`} to="#">
                                 Order Now
                              </Link>
                           </div>
                        </div>
                     ...
                     <div className={`${styles["products"]} `}>
                        ...
                        >
                           ...
                           <div className={styles["content_ceklis"]}>
                              <ul className="text-start mt-4 ">
                                 <li className={styles["one"]}>
                                    <img src={icon_ceklis} alt="ceklis" />1 Shot
                                    of Coffee
                                 </li>
                                 <li className={styles["one"]}>
                                    <img src={icon_ceklis} alt="ceklis" />
            ...
            >
               <div className="col-12">
                  ...
                  <img className={`${styles["map"]}`} src={global} alt="map" />
               </div>
            </section>
