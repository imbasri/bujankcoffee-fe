               ...
               <div className="row gap-2 d-flex justify-content-between">
                  <section className="col-lg-5 col-md-12 col-sm-12 d-flex flex-column align-items-center ">
                     ...
                     <div className={styles.color}>
                        ...
                        <div
                           ...
                           style={{
                              backgroundColor: prevColor ? prevColor : OldHex,
                           }}
                        ></div>
                     </div>
                     <div
                        className={`mt-3 w-100 d-flex align-item-center justify-content-center`}
                     >
                        {showColor ? (
                           <ChromePicker
                              color={color}
                  ...
                  <section className="col-lg-6 col-md-12 col-sm-12 pt-5 ">
                     ...
                     >
                        ...
                        <div className="py-2" onClick={() => setShow(true)}>
                           product : {nameProduct}
                        </div>
                        <div className="py-2" onClick={() => setShow(true)}>
                           size : {sizeProduct}
                        ...
                        <button
                           className={styles.choose_product}
                           onClick={() => setShow(true)}
                        >
                           choose product
                        </button>
                        <label className="pt-3" for="">
                           valid until :
                        </label>
                        <input
                           type="date"
