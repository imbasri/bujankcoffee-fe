...
const ProductDetail = () => {
   ...
   titlebar("Bujank Coffee | Product Detail");
   return (
      <>
         <Navbar />
               ...
               <section className="col-6 col-sm-12 col-lg-6 col-md-6 text-center">
                  <nav className="text-start">
                     <section className="text-start align-items-start fs-5">
                        ...
                        <span>
                           <span className={styles.title_product}>{name}</span>
                        </span>
                     </section>
                  </nav>
                  <img
                  ...
                  >
                     ...
                     <section className="my-4 d-flex flex-wrap">
                        <button
                           value="3"
                           onClick={(e) => setDeliv(e.target.value)}
                           className={
                              deliv === "3"
                                 ? `${styles.btn_delivery_time} ${styles.selected} my-sm-2`
                                 : `${styles.btn_delivery_time} my-sm-2`
                           }
                        >
                           Dine in
                        </button>
